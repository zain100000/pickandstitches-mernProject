...
import "../css/Ladies/LadiesOrderInfo.css";
        ...
        <div className="row pt-2">
          <div className="col-sm-12 col-md-12 col-lg-3">
            <center>
              ...
              {item.samples ? (
                <img
                  src={`https://pickandstitches-deployment-server.onrender.com/api/ladies/${item._id}/samples`}
                  style={{
                    width: "200px",
                    height: "200px",
                    objectFit: "contain",
